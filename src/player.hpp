...
public:
	...
	void attackCollision(Player& player_rect, bool& strong_attack, bool& weak_attack, sf::Keyboard::Key move_left_key, sf::Keyboard::Key move_right_key, float player_width);
