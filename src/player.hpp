...
public:
	...
	void weakAttackCollision(Player& player_rect, bool& weak_attack, bool& player_hit_status);
	void strongAttackCollision(Player& player_rect, bool& player_hit_status, Projectile& proj_rect);
