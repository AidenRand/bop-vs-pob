...
void Player::movePlayer(int player_speed, bool& player_tile_collision, float& dt, int& player_tile_row, int& player_health)
{
	velocity.x = 0;
	player_tile_row = 0;

	// If player is colliding with tile set y vel to zero
	if (!sf::Keyboard::isKeyPressed(sf::Keyboard::S) && player_health > 0)
	{
...
void Player::movePlayer2(int player_speed, bool& player_tile_collision, float& dt, int& player_tile_row, int& player_health)
{
	velocity.x = 0;
	player_tile_row = 0;

	// If player is colliding with tile set y vel to zero
	if (!sf::Keyboard::isKeyPressed(sf::Keyboard::SemiColon) && player_health > 0)
	{
		if (player_tile_collision)
		{
			velocity.y = 0;
...
void Player::attack(int& player_tile_row, int& weak_reload_timer, int& strong_reload_timer, bool& weak_attack, bool& strong_attack)
{
...
void Player::crouchAnimation(int& player_tile_row, bool& player_tile_collision, float& hitbox_y, float& player_height)
{
	player_height = 96;
	hitbox_y = 0;
