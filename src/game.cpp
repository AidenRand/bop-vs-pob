...
void game(sf::RenderWindow& window, float& screen_width, float& screen_height)
{
	...
	while (window.isOpen())
	{
		...
		if (!game_running)
		{
			...
			player_1.attackCollision(player_2, p1_strong_attack_key, p1_weak_attack_key, player_tile_collision, p1_move_left_key, p1_move_right_key, p2_move_left_key, p2_move_right_key);
			...
			player_2.attackCollision(player_1, p2_strong_attack_key, p2_weak_attack_key, player2_tile_collision, p1_move_left_key, p1_move_right_key, p2_move_left_key, p2_move_right_key);
